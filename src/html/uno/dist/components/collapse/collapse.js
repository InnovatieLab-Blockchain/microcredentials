...
var Collapse = (function () {
    ...
    Collapse.prototype.close = function () {
        if (this.details.classList.contains(TOGGLE_CLASS)) {
            ...
            event_1.initEvent('collapse-close', true, true);
    ...
    Collapse.prototype.open = function () {
        if (!this.details.classList.contains(TOGGLE_CLASS)) {
            ...
            event_2.initEvent('collapse-open', true, true);
    ...
    /**
     * Called when a collapse in the same group is opened
     * @param evt
     */
    Collapse.prototype.onCollapseGroupOpen = function (evt) {
        if (evt.currentTarget !== this.host) {
            this.close();
        }
    };
    /**
    ...
    Collapse.prototype.onDetailsUnoAnimationEnd = function () {
        ...
        this.details.setAttribute('aria-hidden', (!isVisible).toString());
    };
    ...
    Collapse.prototype.setupAnimation = function () {
        ...
        this.animate.animationDuration = 20;
